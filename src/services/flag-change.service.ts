...
export class FlagChangeService {
  ...
  private flagSubject: BehaviorSubject<FlagState> = new BehaviorSubject(
    this.currentFlagState,
  );

  constructor() {
    console.log(
      "The FlagChangeService has been created with a default flag state of " +
        this.currentFlagState +
        ".",
    );
  }
  ...
  // public subscribe(): Observer<FlagState> {
